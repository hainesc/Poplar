...
public class CodeBlock : System.Windows.Controls.ContentControl
{
    ...
    /// </summary>
    public Wpf.Ui.Input.IRelayCommand ButtonCommand => (Wpf.Ui.Input.IRelayCommand)GetValue(ButtonCommandProperty);
    ...
    public CodeBlock()
    {
        SetValue(ButtonCommandProperty, new Wpf.Ui.Input.RelayCommand<string>(OnTemplateButtonClick));
